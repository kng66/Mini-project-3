...
first_files_name = os.listdir(
    'hackathon-dataset/hackathon-images/Sally-SIIM/Ma_Surgical_Specimen - 0/L_SPECIMEN_2/')[0]

with open(f'hackathon-dataset/hackathon-images/Sally-SIIM/Ma_Surgical_Specimen - 0/L_SPECIMEN_2/{first_files_name}', 'rb') as infile:
...
app_folder = 'hackathon-dataset/hackathon-images/Sally-SIIM/Ma_Surgical_Specimen - 0/'
totalFiles = 0
totalDir = 0
...
for base, dirs, files in os.walk(app_folder):
    ...
    for file in files:
        ...
        new_instance_section['uid'] = 'urn:oid:' + ds['00080018']['Value'][0]
    ...
    if files:
        ...
        new_series_section['uid'] = 'urn:oid:' + ds['0020000E']['Value'][0]
...
with open('data1.json', 'w') as outfile:
    json.dump(imagingstudy, outfile, indent=4)
